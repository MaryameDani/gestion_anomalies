...
function PermanencierMachineGestionTicket() {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4, backgroundColor: "#FEFEFE" }}>
      <Box sx={{ mb: 4, textAlign: "center" }}>
        ...
        >
          Gestion des Tickets Machine
        </Typography>
        <Typography variant="subtitle1" sx={{ color: "#8B7355" }}>
          Gérez et modifiez les tickets d'arrêt des machines
        </Typography>
      </Box>
      ...
      {tickets.length === 0 && !error ? (
        <Paper sx={{ textAlign: "center", py: 4, backgroundColor: "#F5F5DC" }}>
          ...
          <Typography variant="body2" sx={{ color: "#A0A0A0" }}>
            Aucun ticket d'arrêt machine n'est disponible pour votre rôle.
          </Typography>
        </Paper>
      ) : (
        <TableContainer
        ...
        >
          <Table aria-label="table des tickets d'arrêt machine">
            <TableHead>
...
export default PermanencierMachineGestionTicket